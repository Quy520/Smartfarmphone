...
public class PagerSlidingTabStripIntact extends HorizontalScrollView implements
	...
	public PagerSlidingTabStripIntact(Context context) {
		this(context, null);
	}

	public PagerSlidingTabStripIntact(Context context, AttributeSet attrs) {
		super(context, attrs);
