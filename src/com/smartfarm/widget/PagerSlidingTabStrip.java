...
public class PagerSlidingTabStrip extends HorizontalScrollView implements
	...
	private boolean disableViewPager = false; // 禁用ViewPager
	...
	public void setSelectedById(int id) {
		...
		ViewGroup tabs = getTabsLayout();
		
		for(int i = 0; i < tabs.getChildCount(); i++) {
			
			if(tabs.getChildAt(i).getContentDescription().toString().equals("" + id)) {
	...
	public String getSelectedTab() {
		return currentSelectedTabView.getContentDescription().toString();
	}
