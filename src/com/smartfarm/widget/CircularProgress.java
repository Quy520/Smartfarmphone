...
public class CircularProgress extends View {
    ...
    public CircularProgress(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBorderWidth = a.getDimension(R.styleable.CircularProgress_borderW,
                DEFAULT_BORDER_WIDTH * density);
        a.recycle();
        mColors = new int[COLOR_COUNT];
        mColors[0] = context.getResources().getColor(R.color.loading_step1);
        mColors[1] = context.getResources().getColor(R.color.loading_step2);
        mColors[2] = context.getResources().getColor(R.color.loading_step3);
        mColors[3] = context.getResources().getColor(R.color.loading_step4);
        mColors[4] = context.getResources().getColor(R.color.loading_step5);
        mColors[5] = context.getResources().getColor(R.color.loading_step6);
    ...
    private void toggleAppearingMode() {
        ...
        if (mModeAppearing) {
            mCurrentColorIndex = ++mCurrentColorIndex % COLOR_COUNT;
            mNextColorIndex = ++mNextColorIndex % COLOR_COUNT;
