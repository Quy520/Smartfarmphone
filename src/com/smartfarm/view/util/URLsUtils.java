...
public class URLsUtils implements Serializable {
    ...
    private static String getImageUrl(boolean ori, String name) {
    	
    	StringBuilder result = new StringBuilder();
    	
    	result.append(ApiHttpClient.PYTHON_SERVER_STATIC_URL);
     ...
     * @return
     */
    public static String getOriginalImageUrl(String name) {
    	
    	return getImageUrl(true, name);
    }
     ...
     * @return
     */
    public static String getThumbImageUrl(String name) {
    	
    	return getImageUrl(false, name);
    }
